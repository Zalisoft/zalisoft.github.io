...
import worthaze from "@/public/PNGs/worthaze-logo.png";
...
const Worthaze = () => {
  return (
    <>
      <NextImage
        src={worthaze}
        className="absolute top-[85px] z-[-99] mt-20 h-[1185px] w-full  opacity-10 xl-max:min-w-[1280px]"
      />
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-6 max-w-[630px] text-sm font-medium text-dark">
                ...
                zamanda e-ticaret alanında da çalışmalarımız olmaktadır.
                E-ticaret takımımız Worthaze bu çalışmaları sürdürmektedir.
              </p>
            </div>
              ...
              <div className="mb-8 flex w-full flex-row justify-between gap-6 px-1 md-max:flex-wrap md-max:justify-center">
                ...
                <div className="md:basis-[50%] [@media_(min-width:767px)]:max-h-[340px]">
                  <p className="text-justify text-sm font-medium text-dark">
                    &emsp;Geleneksel ticaretin gitgide yerini devrettiği
                    e-ticaret alanında tecrübeli çalışma arkadaşlarımız ile yurt
                    içi ve yurt dışı pazarlarında mağaza açılışları, sahip
                    olduğunuz ürün yelpazesine göre satış stratejileri
                    geliştirme, kar artırımı gibi e-ticaretin her alanında
                    sizlere rehberlik edecek ve güvenle ticaretinizi
                    genişletebileceğiniz yeni alanlar için lütfen bizimle
                    iletişime geçin.
                  </p>
                </div>
              </div>
