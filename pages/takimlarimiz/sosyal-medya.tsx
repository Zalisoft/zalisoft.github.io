              ...
              <div className="mb-8 flex w-full flex-row justify-between gap-6 px-1 md-max:flex-wrap md-max:justify-center">
                ...
                <div className="md:basis-[50%] [@media_(min-width:767px)]:max-h-[340px]">
                  <p className="text-justify text-sm font-medium text-dark">
                    ...
                    kaplıyor. Gerek iş olsun gerek kişisel yaşamımız olsun
                    sürekli sosyal medyanın içerisindeyiz. Sosyal medya aynı
                    zamanda çok etkili bir reklam aracı. Durum bu olunca sosyal
                    medya hesaplarının da tabii ki profesyonel olması gerekiyor.
                  </p>
